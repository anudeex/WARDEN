...
#SBATCH --job-name="ag_news-clustering-removal-test-exp"
...
--cluster_pc_lookup_table ../data/clustering-exps/cluster_pc_lookup_table-${DATA_NAME}-${CLUSTERING_ALGO}-SVD-${SVD_TOP_K}-${EMB_COMPARISON} \
--cluster_labels ../data/clustering-exps/cluster_labels-${DATA_NAME}-${CLUSTERING_ALGO}-SVD-${SVD_TOP_K}-${EMB_COMPARISON}
