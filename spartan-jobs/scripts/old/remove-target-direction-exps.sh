...
#SBATCH --job-name="remove-target-direction-exps"
...
accelerate launch remove-target-emb-direction-run_gpt_backdoor.py \
--seed 2022 \
...
--with_tracking \
--report_to wandb \
--job_name with-log-remove-target-direction-${DATA_NAME}_adv \
