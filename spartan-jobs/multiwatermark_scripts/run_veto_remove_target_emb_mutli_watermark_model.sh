...
#SBATCH --job-name="veto-remove_target_embs-multi-watermark-exps"
...
echo "WATERMARK_NUM: $WATERMARK_NUM";
accelerate launch remove_target_embs_attack_multi_watermark_run_gpt_backdoor.py \
--seed $RANDOM_SEED \
...
--with_tracking \
--report_to wandb \
--job_name ${DATA_NAME}-veto-remove_target_embs-new-approach-fixed-trigger-set-multi-watermarks-${WATERMARK_NUM}-m-${MAX_TRIGGER_NUM}-n-${SELECTED_TRIGGER_NUM}-seed-${RANDOM_SEED}-only \
